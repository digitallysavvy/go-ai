...
This ensures consumers receive all content before any tool side-effects fire. If your application previously relied on tool results arriving mid-stream, see the [v0.3 to v0.4 migration guide](../08-migration-guides/from-v0.3-to-v0.4.mdx) for details.
