...
> **Note:** The DeepInfra provider automatically fixes token counting issues for Gemini/Gemma models.
> See [Token Counting Fix](#token-counting-fix) section for details.
...
**The Fix:**
The Go-AI SDK automatically detects and corrects this:
```go
...
result, err := ai.GenerateText(model, "Explain quantum computing")
