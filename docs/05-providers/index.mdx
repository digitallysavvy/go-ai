...
- [QuiverAI](31-quiverai.mdx) - SVG generation and image vectorization
...
- [Voyage](34-voyage.mdx) - Embeddings and reranking models
...
```go
result, err := ai.GenerateText(ctx, ai.GenerateTextOptions{Model: model, Prompt: "What is the Go-AI SDK?"})
if err != nil {
    log.Fatal(err)
}
...
**Image Generation**: Stability AI, Black Forest Labs, FAL, Prodia, QuiverAI
