...
Assistant tool-call content preserves ordered model output, including provider-executed tool calls and Google `thoughtSignature` metadata for round trips.
