...
- **Metadata**: Model IDs, parameters, and explicitly included context
...
func main() {
    ...
    log.Println("✅ Traces sent to MLflow at http://localhost:5000")
}
```
...
telemetrySettings := &telemetry.Options{
    ...
    // Explicit context inclusion for telemetry
...
### 2. Include Safe Context

```go
telemetrySettings.IncludeRuntimeContext = map[string]bool{
    "request_id": true,
    "feature_flag": true,
    "ab_test_group": true,
}
