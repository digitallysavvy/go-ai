        ...
        "person": map[string]interface{}{
            ...
            "properties": map[string]interface{}{
                "name": map[string]interface{}{
                    "type": "object",
                    "properties": map[string]interface{}{
                        "first": map[string]string{"type": "string"},
                        "middle": map[string]string{"type": "string"},
                        "last": map[string]string{"type": "string"},
                        // ... too deep
                    },
                },
            },
...
SOCIAL MEDIA: "🌱 Power Up Plant-Based"
...
// ❌ Avoid: High temperature with tools
...
promptTokens := len(prompt) / 4 // Rough estimate (1 token ≈ 4 chars)
