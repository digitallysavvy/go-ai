...
func main() {
	...
	// Text to synthesize
	text := "Hello from the Go AI SDK! This speech is being generated 50% faster than normal speed."

	// Speed multiplier (1.5 = 50% faster)
	speed := 1.5

	fmt.Printf("Generating speech at %.1fx speed...\n", speed)
